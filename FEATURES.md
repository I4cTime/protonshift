# ProtonShift — Features

Everything you need to configure Linux games, in one place.
...
**Electron** (recommended) — Modern UI built with Next.js 16, React 19, Tailwind CSS v4, and HeroUI v3. Packages as AppImage and `.deb`.

**GTK** (native fallback) — Original GTK4 + libadwaita interface for a lightweight, dependency-free experience.

Both frontends share the same Python FastAPI backend.
